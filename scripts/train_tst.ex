...
path = "../data/1-billion-word-language-modeling-benchmark-r13output/training-monolingual.tokenized.shuffled/news.en-00090-of-00100"
...
sentences = Enum.to_list(1..sentences_n) |> Enum.map(fn i ->
  sentence = Enum.at(sentences, i - 1)
  {:batch, word_ctxs} = Dataset.word_ctx(Enum.into(vocab_list, %{}), window, sentence)
  word_ctxs
end)
